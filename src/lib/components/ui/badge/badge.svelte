...
export const badgeVariants = tv({
  ...
  variants: {
    variant: {
      ...
      success: 'bg-success/12 text-success focus-visible:ring-success/25 [a]:hover:bg-success/18',
      warning: 'bg-warning/12 text-warning focus-visible:ring-warning/25 [a]:hover:bg-warning/18',
